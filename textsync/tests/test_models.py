...
class ExpiringTokenModelTest(TestCase):
    ...
    def test_token_expiration_180_days(self):
        ...
        self.assertAlmostEqual(
            token.expires_at.timestamp(), expected_expiry.timestamp(), delta=60
        )
...
class ShortcutSetModelTest(TestCase):
    ...
    def test_set_types(self):
        ...
        general_set = ShortcutSet.objects.create(name="general-set", set_type="general")
    ...
    def test_visible_to_many_to_many(self):
        ...
        shortcut_set = ShortcutSet.objects.create(name="shared-set", owner=self.user)
    ...
    def test_set_string_representation(self):
        ...
        shortcut_set = ShortcutSet.objects.create(name="my-set", set_type="personal")
...
class ShortcutModelTest(TestCase):
    ...
    def setUp(self):
        ...
        self.shortcut_set = ShortcutSet.objects.create(name="test-set", owner=self.user)
    ...
    def test_shortcut_multiple_sets(self):
        ...
        shortcut = Shortcut.objects.create(
            key="multi", value="In multiple sets", owner=self.user
        )
    ...
    def test_shortcut_updated_at_auto(self):
        ...
        shortcut = Shortcut.objects.create(
            key="track", value="Original", owner=self.user
        )
